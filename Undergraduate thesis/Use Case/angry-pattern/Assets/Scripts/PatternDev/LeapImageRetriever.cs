...
public class LeapImageRetriever : MonoBehaviour
{
  ...
  public void LoadMainTexture(ref Image image)
  {
  ...
  public bool LoadDistortion(ref Image image)
  {
...
//{
//	public static void Read (LeapImageRetriever lir, ref Image image)
//	{
//		lir.LoadMainTexture (ref image);
//		lir.LoadDistortion(ref image);
//	}
//
