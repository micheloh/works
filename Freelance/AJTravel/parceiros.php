...
<html>
    ...
    <style>
        ...
        div#conteudo div#conteudoMain span#mainTitulo
        {
            padding-right: 10px;
            padding-left: 20px;
        }
        ...
        <div id="conteinerPrincipal">
            ...
            <div id="paginasDiv">
                <div id="conteudo">
                    ...
                    <div id="conteudoMain">
                        <span id="mainTitulo"><b>PARCEIROS</b></span><br><br>
                        <?php
				...
				parceiroTitulo,
                                parceiroDesc,
                                parceiroURL
				from ajTravelParceiro
                                ")) {
                            if ($statement->execute()) {
                                $statement->bind_result($titulo, $descricao, $URL);
                                while ($statement->fetch()) {
                                    ?>                                    
                                    <span id="Titulo"><?php echo htmlentities($titulo); ?></span><br><br>
                                    <div id="Conteudo">                                    
                                        <div id="interno">
                                            <?php
                                            if ($URL != '') {
                                                ?>
                                                <img src="Parceiros/<?php echo $URL; ?>" width="200" height="100"/><br><br>
                                                <?php
                                            }
                                            ?>
                                            <?php echo htmlentities(nl2br($descricao)); ?>
                                            </span>
                                        </div>
                                    </div>                                        
                                    <?php
