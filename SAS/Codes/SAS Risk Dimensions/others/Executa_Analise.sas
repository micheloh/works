...
%let ENVNAME = D:\SAS\SASBI\Lev1\AppData\SASRiskManagementForBanking\3.2\data\userdata\sasdemo\entities\main\playpens\testele\cfg\rd_env\market\rmb_market_environment;
