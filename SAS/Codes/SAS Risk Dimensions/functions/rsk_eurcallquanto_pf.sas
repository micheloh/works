/*****************************************************************************
   ...
   NAME: rsk_eurcallquanto_pf.sas

   PURPOSE: Quanto pricing call option pricing by Reiner (1992).
   ...
   USAGE: 
	  Value = rsk_eurcallquanto_pf( CurrencyValue, Price, Strike, TimeToExpiration, RiskFreeRate,
...
function rsk_eurcallquanto_pf(CurrencyValue, Price, Strike, TimeToExpiration, RiskFreeRate,
                ForeignRiskFree, DivYield, PriceVol, CurrencyVol, Correlation)
    ...
    OptionPrice = CurrencyValue * (Price * exp((cost - RiskFreeRate) * TimeToExpiration) * probnorm(d1) 
